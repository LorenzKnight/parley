<template>
    <div class="users_list">
        ...
        <userform ref="userform" :header="'create new'" v-else-if="showForm" id="user_form"/>
        <userform ref="userform" id="userform" :header="'ID: ' + data[showFormR].id" v-else-if="showFormR !==-1" id="user_form" @submit="submit"/>
    </div>
</template>
<script>
